...
$$
\frac{∂g(i,:)}{∂\Lambda_{copy}(i,:,:)} = -0.5g\cdot (r-m_{copy})^T(r-m_{copy})
$$
$$
\left[\frac{∂L}{∂p} \cdot \frac{∂p}{∂T} \cdot \frac{∂T}{∂\Lambda}\right](i,1) = \sum_{m=S_{i-1}+1}^{S_{i}} \sum_{k \geqq m} \frac{∂L}{∂p}\left(k,\ :\right)\left\{0.5\frac{\sigma(m,k) \cdot o_{copy}(k,1) \cdot g(k,1)}{1-o_{copy}(k,1)\cdot g(k,1)}\cdot p(k,:)\right\}^T\left\{r(k,:)-m_{copy}(k,:)\right\}^T\left\{r(k,:)-m_{copy}(k,:)\right\}
$$
$$
\left[\frac{∂L}{∂p} \cdot \frac{∂p}{∂g} \cdot \frac{∂g}{∂\Lambda_{copy}}\cdot \frac{∂\Lambda_{copy}}{∂\Lambda}\right](i,:)= \sum_{k=S_{i-1}+1}^{S_i}-0.5\frac{∂L}{∂p}\left(k,\ :\right)\left[T\cdot l_{copy} \cdot o_{copy} \cdot g\right]^T(k,\ :)\left\{r(k,:)-m_{copy}(k,:)\right\}^T\left\{r(k,:)-m_{copy}(k,:)\right\}
$$